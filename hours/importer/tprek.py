...
from ..models import Target, DataSource, TargetType, LinkType
...
class TPRekImporter(Importer):
    ...
    def setup(self):
        ...
        self.ADMIN_URL_BASE = 'https://asiointi.hel.fi/tprperhe/TPR/UI/ServicePoint/ServicePointEdit/'
    ...
    def get_unit_identifiers(self, unit_id: str, data: dict) -> list:
        ...
        if 'sources' in data:
            for source in data["sources"]:
                # do *not* store tprek internal identifier, we want nothing to do with it
