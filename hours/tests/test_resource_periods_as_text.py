...
def test_resource_opening_hours_as_text(resource):
    ...
    with translation.override("sv"):
        assert resource.get_date_periods_as_text() == (
            ...
            "Öppethållningsperiod: 1 januari 2021 - 31 december 2022\n"
            "Öppettider:\n"
            "\n"
            " Måndag-Tisdag, Torsdag 9.00-17.00 Öppet\n"
            " Fredag-Lördag 9.00-19.00 Öppet\n"
            " Söndag 10.00-14.00 Öppet\n"
            "\n"
            "Giltig när alla följanär gäller:\n"
            " - Av period varje jämn vecka\n"
            "\n"
            " ---------------------------------------\n"
            "\n"
            " Måndag-Tisdag 8.00-16.00 Öppet\n"
            " Lördag-Söndag 9.00-13.00 Öppet\n"
            "\n"
            "Giltig när alla följanär gäller:\n"
            " - Av period varje 2:a månad\n"
            " - Av period varje udd vecka\n"
            "\n"
            "========================================\n"
            "Special hours\n"
            "Öppethållningsperiod: 27 december 2021 - 2 januari 2022\n"
            "Öppettider:\n"
            "\n"
            " Stängt\n"
            "\n"
    ...
    with translation.override("en"):
        assert resource.get_date_periods_as_text() == (
            ...
            "Opening hours:\n"
            "\n"
            " Monday-Tuesday, Thursday 9.00-17.00 Open\n"
            " Friday-Saturday 9.00-19.00 Open\n"
            ...
            " ---------------------------------------\n"
            "\n"
            " Monday-Tuesday 8.00-16.00 Open\n"
            " Saturday-Sunday 9.00-13.00 Open\n"
            "\n"
            " In effect when every one of these match:\n"
